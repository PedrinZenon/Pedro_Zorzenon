const observer = new IntersectionObserver((entries) => {
  ...
  const translations = {
    "pt": {
      ...
      "project.hourglass.description": "O projeto HourGlass é uma plataforma digital para gestão eficiente de tempo e produtividade. A solução propõe interfaces limpas e funcionais, integrando ferramentas para organização pessoal e profissional pare empresas.",
      ...
      "message.success": "Valeu! Me dá 1 minuto que já te chamo."
    },
    "en": {
      "title": "Pedro Zorzenon",
      ...
      "project.hourglass.title": "HourGlass",
      "project.hourglass.description": "HourGlass is a digital platform for efficient time management and productivity for companys. The solution offers clean and functional interfaces, integrating tools for personal and professional organization for companies.",
      "project.itau.title": "Itaú",
      ...
      "message.success": "Thanks! I'll reach out to you soon."
    }
  };
